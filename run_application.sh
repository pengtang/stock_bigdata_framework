...
# sh /Users/pengtang/Downloads/spark-2.0.0-bin-hadoop2.7/bin/spark-submit --jars ~/big_data_client_packages/src/spark-streaming-kafka-0-8-assembly_2.11-2.0.0.jar ~/big_data_client_packages/src/spark_stream.py stock-analyzer stock-average 192.168.99.103:9092
